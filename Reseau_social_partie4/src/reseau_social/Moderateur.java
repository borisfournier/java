...
public class Moderateur extends Utilisateur implements Salarie{
    ...
    private int chequeCadeaux;
//attributs    
    static Scanner sc = new Scanner(System.in);
    
//constructeur   
    public Moderateur(String nom, String prenom, int age, String sexe, int droit, int chequeCadeaux){
        super(nom,prenom,age,sexe);
        this.droit = droit;
        this.chequeCadeaux = chequeCadeaux;
    }
...
//méthodes
    ...
    public void recevoirPaiement(){
        System.out.println("Je reçois " + chequeCadeaux + " cheques cadeaux pour mes efforts!!!\n");
    }
